...
class SVGPSurrogate:
    """
    Lightweight inducing-point GP-style surrogate.
    It uses RBF features centered at learnable inducing points and Bayesian linear
    regression in feature space. This keeps the BayesWarp code self-contained,
    avoids heavyweight GP dependencies, and preserves the exploration logic:
